...
# Tombol
class Button:
    def _init_(self, rect, color, text, font_size=30):
...
buttons = {
    ...
    "random": Button((250, 50, 150, 50), BLUE, "Acak"),
    "start": Button((450, 50, 150, 50), GREEN, "Start"),
    "stop": Button((650, 50, 150, 50), RED, "Stop"),
}
